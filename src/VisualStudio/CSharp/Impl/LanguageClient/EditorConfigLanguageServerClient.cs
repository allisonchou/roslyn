...
namespace Microsoft.VisualStudio.LanguageServices.CSharp.LanguageClient
{
    ...
    internal class EditorConfigLanguageServerClient : AbstractLanguageServerClient
    {
        [ImportingConstructor]
        [Obsolete(MefConstruction.ImportingConstructorMessage, error: true)]
        public EditorConfigLanguageServerClient(
            ...
            : base(
                ...
                eventListener,
                listenerProvider,
                languageServerName: WellKnownServiceHubServices.EditorConfigLanguageServer,
                serviceHubClientName: "ManagedLanguage.IDE.EditorConfigLanguageServer")
        {
        }

        public override string Name => CSharpVSResources.EditorConfig_language_server_client;  // Does this go here?
    }
}
